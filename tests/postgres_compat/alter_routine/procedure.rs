...
//!
//! ALTER PROCEDURE parses into [`sqlparser::ast::Statement::AlterObject`] with an
...
fn test_alter_procedure_rename_basic() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc RENAME TO new_proc");
}
...
fn test_alter_procedure_rename_with_args() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE update_record(INTEGER, TEXT) RENAME TO modify_record");
}
...
fn test_alter_procedure_rename_qualified() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE myschema.myproc(TEXT) RENAME TO newproc");
}
...
fn test_alter_procedure_rename_no_args() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE cleanup_temp() RENAME TO cleanup_temporary");
}
...
fn test_alter_procedure_owner_basic() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc OWNER TO new_owner");
}
...
fn test_alter_procedure_owner_with_args() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE process_data(NUMERIC, TEXT) OWNER TO admin");
}
...
fn test_alter_procedure_owner_current_user() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() OWNER TO CURRENT_USER");
}
...
fn test_alter_procedure_owner_current_role() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() OWNER TO CURRENT_ROLE");
}
...
fn test_alter_procedure_owner_session_user() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() OWNER TO SESSION_USER");
}
...
fn test_alter_procedure_set_schema() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc SET SCHEMA new_schema");
}
...
fn test_alter_procedure_set_schema_with_args() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE archive_data(DATE) SET SCHEMA archive");
}
...
fn test_alter_procedure_set_schema_qualified() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE old_schema.my_proc() SET SCHEMA new_schema");
}
...
fn test_alter_procedure_security_definer() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE privileged_operation() SECURITY DEFINER");
}
...
fn test_alter_procedure_security_invoker() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE public_operation() SECURITY INVOKER");
}
...
fn test_alter_procedure_set_config() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() SET search_path TO myschema, public");
}
...
fn test_alter_procedure_set_config_equals() {
    // https://www.postgresql.org/docs/current/sql-alterprocedure.html
    // SET with = syntax
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() SET work_mem = '256MB'");
}
...
fn test_alter_procedure_set_config_from_current() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() SET timezone FROM CURRENT");
}
...
fn test_alter_procedure_reset_config() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() RESET search_path");
}
...
fn test_alter_procedure_reset_all() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() RESET ALL");
}
...
fn test_alter_procedure_depends_on_extension() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() DEPENDS ON EXTENSION my_extension");
}
...
fn test_alter_procedure_no_depends_on_extension() {
    ...
    pg_roundtrip_only!("ALTER PROCEDURE my_proc() NO DEPENDS ON EXTENSION my_extension");
}
