...
//!
//! ALTER FUNCTION parses into [`sqlparser::ast::Statement::AlterObject`] with an
//! [`sqlparser::ast::AlterObjectTarget::Routine`] target.
...
fn test_alter_function_rename_basic() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func RENAME TO new_func");
}
...
fn test_alter_function_rename_with_args() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION add(INTEGER, INTEGER) RENAME TO sum_integers");
}
...
fn test_alter_function_rename_qualified() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION myschema.myfunc(TEXT) RENAME TO newfunc");
}
...
fn test_alter_function_rename_no_args() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION get_time() RENAME TO current_time");
}
...
fn test_alter_function_owner_basic() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func OWNER TO new_owner");
}
...
fn test_alter_function_owner_with_args() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION calculate(NUMERIC, NUMERIC) OWNER TO admin");
}
...
fn test_alter_function_owner_current_user() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() OWNER TO CURRENT_USER");
}
...
fn test_alter_function_owner_current_role() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() OWNER TO CURRENT_ROLE");
}
...
fn test_alter_function_owner_session_user() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() OWNER TO SESSION_USER");
}
...
fn test_alter_function_set_schema() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func SET SCHEMA new_schema");
}
...
fn test_alter_function_set_schema_with_args() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION process(TEXT, INTEGER) SET SCHEMA archive");
}
...
fn test_alter_function_set_schema_qualified() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION old_schema.my_func() SET SCHEMA new_schema");
}
...
fn test_alter_function_immutable() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION calculate(INTEGER) IMMUTABLE");
}
...
fn test_alter_function_stable() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION get_current_value() STABLE");
}
...
fn test_alter_function_volatile() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION random_number() VOLATILE");
}
...
fn test_alter_function_strict() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION divide(NUMERIC, NUMERIC) STRICT");
}
...
fn test_alter_function_returns_null_on_null_input() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION divide(NUMERIC, NUMERIC) RETURNS NULL ON NULL INPUT");
}
...
fn test_alter_function_called_on_null_input() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION coalesce_custom(TEXT, TEXT) CALLED ON NULL INPUT");
}
...
fn test_alter_function_parallel_safe() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION calculate(INTEGER) PARALLEL SAFE");
}
...
fn test_alter_function_parallel_unsafe() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION write_log(TEXT) PARALLEL UNSAFE");
}
...
fn test_alter_function_parallel_restricted() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION get_sequence_value() PARALLEL RESTRICTED");
}
...
fn test_alter_function_cost() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION expensive_calc(INTEGER) COST 1000");
}
...
fn test_alter_function_cost_fractional() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION simple_calc(INTEGER) COST 0.5");
}
...
fn test_alter_function_rows() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION generate_series_custom(INTEGER, INTEGER) ROWS 100");
}
...
fn test_alter_function_cost_and_rows() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION get_records() COST 500 ROWS 1000");
}
...
fn test_alter_function_security_definer() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION privileged_operation() SECURITY DEFINER");
}
...
fn test_alter_function_security_invoker() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION public_operation() SECURITY INVOKER");
}
...
fn test_alter_function_leakproof() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION compare_hash(TEXT, TEXT) LEAKPROOF");
}
...
fn test_alter_function_not_leakproof() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION debug_info(TEXT) NOT LEAKPROOF");
}
...
fn test_alter_function_set_config() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() SET search_path TO myschema, public");
}
...
fn test_alter_function_set_config_equals() {
    // https://www.postgresql.org/docs/current/sql-alterfunction.html
    // SET with = syntax
    pg_roundtrip_only!("ALTER FUNCTION my_func() SET work_mem = '256MB'");
}
...
fn test_alter_function_set_config_from_current() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() SET timezone FROM CURRENT");
}
...
fn test_alter_function_reset_config() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() RESET search_path");
}
...
fn test_alter_function_reset_all() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() RESET ALL");
}
...
fn test_alter_function_depends_on_extension() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() DEPENDS ON EXTENSION my_extension");
}
...
fn test_alter_function_no_depends_on_extension() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION my_func() NO DEPENDS ON EXTENSION my_extension");
}
...
fn test_alter_function_multiple_options() {
    ...
    pg_roundtrip_only!("ALTER FUNCTION calculate(INTEGER) IMMUTABLE PARALLEL SAFE COST 10");
}
