...
//! PostgreSQL Trigger Compatibility Tests
//!
//! This module contains comprehensive tests for PostgreSQL trigger support,
//! including CREATE TRIGGER, ALTER TRIGGER, and CREATE EVENT TRIGGER statements.
//!
