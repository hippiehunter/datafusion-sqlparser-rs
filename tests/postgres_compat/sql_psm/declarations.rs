...
fn test_declare_with_collation() {
    ...
    pg_roundtrip_only!(
        r#"CREATE FUNCTION test() RETURNS void AS $$ DECLARE name TEXT COLLATE "en_US"; BEGIN NULL; END $$ LANGUAGE plpgsql"#
    );
}
...
fn test_declare_label_qualification() {
    ...
    // TODO: <<label>> before nested DECLARE/BEGIN blocks not yet supported
