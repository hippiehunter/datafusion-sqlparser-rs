...
/// PostgreSQL's reserved keywords: the words its `ColId`/`func_name`
/// productions reject, and which therefore can never be a bare column alias or
/// introduce a typed literal of the form `type_name 'literal'`.
pub const POSTGRES_RESERVED_KEYWORDS: &[Keyword] = &[
    Keyword::ALL,
    Keyword::ANALYZE,
    Keyword::AND,
    Keyword::ANY,
