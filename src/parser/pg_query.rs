...
impl Parser<'_> {
    ...
    /// Parse the identifier list of a `JOIN ... USING (cols) AS alias` clause's
    /// alias, positioned after the closing parenthesis of the column list.
    pub(super) fn parse_join_using_alias(&self) -> Result<Option<Ident>, ParserError> {
