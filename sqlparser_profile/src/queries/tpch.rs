...
//!
//! All 22 standard TPC-H queries for database performance benchmarking.
//! These queries exercise various SQL features:
...
/// All TPC-H queries as a slice for iteration
pub const TPCH_QUERIES: &[(&str, &str)] = &[
    ("tpch_q1", TPCH_Q1),
    ("tpch_q2", TPCH_Q2),
    ("tpch_q3", TPCH_Q3),
    ("tpch_q4", TPCH_Q4),
